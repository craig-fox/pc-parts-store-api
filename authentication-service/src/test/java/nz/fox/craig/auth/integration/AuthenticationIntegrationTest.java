...
class AuthenticationIntegrationTest {
    ...
    void shouldLoginSuccessfully() throws Exception {
        ...
        when(customerClient.findByEmail("jane@example.com"))
                .thenReturn(jane);
        ...
        mockMvc.perform(post("/api/auth/login")
                ...
                .andExpect(jsonPath("$.customerId")
                        .value(jane.id().toString()))
                .andExpect(jsonPath("$.firstName")
                        .value("Jane"))
                .andExpect(jsonPath("$.preferredName")
                        .value("Jo"));
    ...
    void shouldRejectInvalidEmailFormat() throws Exception {
        ...
        mockMvc.perform(post("/api/auth/login")
                ...
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath("$.message")
                        .value("email: Email must be valid"));
    ...
    void shouldRejectWrongPassword() throws Exception {
        ...
        when(customerClient.findByEmail(JANE_EMAIL))
                .thenReturn(jane);
    ...
    private AuthenticatedCustomer authenticatedCustomer(String email, boolean active, String... preferredName) {
