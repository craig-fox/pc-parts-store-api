...
class CustomerControllerTest {
    ...
    void createCustomer() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.displayName").value("Jo"))
    ...
    void createCustomerWithInvalidEmail() throws Exception {
        CustomerRequest request =
                new CustomerRequest("Jane", "Doe", null, "not-an-email", "123 Main St", PASSWORD);
    ...
    void updateCustomer() throws Exception {
        CustomerRequest request =
                new CustomerRequest(
                        "Jane", "Smith", null, "jane.smith@example.com", "456 Oak Ave", PASSWORD);
        CustomerResponse response =
                new CustomerResponse(
                        CUSTOMER_ID,
                        "Jane",
